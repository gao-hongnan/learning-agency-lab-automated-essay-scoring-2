...
class SubclassedDebertaV2ForSequenceClassification(DebertaV2PreTrainedModel):  # type: ignore[misc]
    ...
    def forward(
        ...
        pooled_output = self.pooler(  # SHAPE: [B, D] say [8, 768] think of T tokens in a sentence compressed to 1 sentence embeddings of D dim
...
class SubclassedDebertaV2ForSequenceClassificationMultiHead(DebertaV2PreTrainedModel):  # type: ignore[misc]
    """Keeping everything almost the same as `SubclassedDebertaV2ForSequenceClassification`
    except for the addition of multihead support and topic ids in `forward`.
    """
    ...
    def forward(
        ...
        token_type_ids: torch.Tensor | None = None,
        position_ids: torch.Tensor | None = None,
        topic_ids: torch.Tensor | None = None,
        inputs_embeds: torch.Tensor | None = None,
        labels: torch.Tensor | None = None,
        output_attentions: bool | None = None,
        output_hidden_states: bool | None = None,
